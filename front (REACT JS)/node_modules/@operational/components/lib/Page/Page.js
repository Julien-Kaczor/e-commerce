...
const ViewContainer = styled_1.default("div")(({ theme, isInTab, isTitleCondensed, hasTitle }) => {
    const calculatedTitleOffset = isInTab && !isTitleCondensed ? theme.titleHeight + Tabs_1.tabsBarHeight : theme.titleHeight;
    return {
...
const FixedProgress = styled_1.default(Progress_1.default) `
  ...
  width: 100vw;
`;
const PageTitle = styled_1.default(Title_1.Title) `
  margin: 0;
`;
const initialState = {};
    ...
    renderPageWithTabs() {
        ...
        return (React.createElement(Tabs_1.default, { tabs: tabs, activeTabName: this.props.activeTabName, onTabChange: this.props.onTabChange, condensed: condensedTitle }, ({ tabsBar, activeChildren }) => (React.createElement(React.Fragment, null,
            title ? (React.createElement(TitleBar, { color: color },
                ...
                !condensedTitle && tabsBar)) : (React.createElement(TitleBar, { color: color }, tabsBar)),
            React.createElement(ViewContainer, { isInTab: true, isTitleCondensed: condensedTitle, hasTitle: true }, activeChildren)))));
    }
        ...
        return (React.createElement(React.Fragment, null,
            title && (React.createElement(TitleBar, { color: color },
                React.createElement(TitleContainer, null,
                    React.createElement(PageTitle, null, title),
                    React.createElement(ActionsContainer, { actionPosition: actionsPosition }, actions)))),
            React.createElement(ViewContainer, { hasTitle: Boolean(title) },
                React.createElement(PageContent_1.default, { noPadding: Boolean(noPadding), areas: areas, fill: fill }, modalConfirmContext => {
                    const resolvedChildren = typeof children === "function" ? children(modalConfirmContext) : children;
                    return areas === "main" ? React.createElement(PageArea_1.default, { fill: fill }, resolvedChildren) : resolvedChildren;
                }))));
    }
    render() {
