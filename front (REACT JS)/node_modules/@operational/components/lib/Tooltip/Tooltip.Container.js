...
exports.Container = styled_1.default("div")(({ position, offScreenWidthTest, singleLineTextWidth, theme }) => {
    const backgroundColor = tinycolor2_1.default(theme.color.black)
        .setAlpha(0.9)
        .toString();
    return Object.assign({ backgroundColor, label: "tooltip", color: theme.color.white, position: "absolute", zIndex: theme.zIndex.tooltip, borderRadius: 2, boxShadow: "0 2px 6px rgba(0, 0, 0, .15)" }, (offScreenWidthTest
        ? {
            width: "fit-content",
            whiteSpace: "nowrap",
            position: "fixed",
