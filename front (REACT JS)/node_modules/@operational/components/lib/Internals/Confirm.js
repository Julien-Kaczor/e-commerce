...
exports.Actions = styled_1.default("div") `
  margin-top: ${({ theme }) => theme.space.element}px;
  align-self: flex-end;
  height: ${actionsBarSize}px;
`;
exports.ControlledModalContent = styled_1.default("div")(({ fullSize, theme }) => (Object.assign({ 
...
class Confirm extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            isOpen && (React.createElement(ControlledModal_1.default, { type: "confirm", fullSize: fullSize, title: title, onClose: this.closeConfirm, closeOnOverlayClick: closeOnOverlayClick },
                React.createElement(exports.ControlledModalContent, { fullSize: Boolean(fullSize) }, typeof Body === "function" && state ? (React.createElement(Body, { setConfirmState: this.setConfirmState, confirmState: state })) : (Body)),
                React.createElement(exports.Actions, { "data-cy": "confirm__actions" },
                    cancelButton !== null &&
                        React.cloneElement(typeof cancelButton === "function"
                            ? cancelButton(state)
                            : cancelButton || React.createElement(Button_1.default, null, "Cancel"), {
