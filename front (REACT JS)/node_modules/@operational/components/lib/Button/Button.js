...
const ButtonSpinner = styled_1.default(Spinner_1.default)(({ theme, containerColor }) => ({
    position: "absolute",
    top: "50%",
    left: "50%",
...
const BaseButton = styled_1.default("button")(({ theme, color_, disabled, condensed, loading, fullWidth, textColor }) => {
    ...
    return Object.assign({ backgroundColor, lineHeight: `${condensed ? 28 : 36}px`, fontSize: theme.font.size.small, fontFamily: theme.font.family.main, fontWeight: theme.font.weight.medium, display: "inline-flex", alignItems: "center", justifyContent: "center", padding: `0 ${condensed ? theme.space.medium : theme.space.element}px`, borderRadius: theme.borderRadius, border: 0, boxShadow: utils_1.isWhite(backgroundColor) ? `0 0 0 1px ${theme.color.border.disabled} inset` : "none", cursor: disabled ? "not-allowed" : "pointer", opacity: disabled ? 0.6 : 1.0, outline: "none", position: "relative", width: fullWidth ? "100%" : "initial", marginRight: theme.space.small, 
        ...
        }, ":focus": Object.assign({}, utils_1.inputFocus({ theme, isError: color_ === "error" })) }, (!disabled
        ? {
            ":hover": {
...
const Button = (_a) => {
    var { to, children, icon, iconPosition, iconSize = 18, iconColor, color, onClick, tabIndex } = _a, props = __rest(_a, ["to", "children", "icon", "iconPosition", "iconSize", "iconColor", "color", "onClick", "tabIndex"]);
    const iconProps = { name: icon, size: iconSize, color: iconColor };
    return (React.createElement(OperationalContext_1.default, null, ctx => (React.createElement(BaseButton, Object.assign({}, props, { as: to ? "a" : undefined, role: "button", "aria-label": typeof children === "string" ? children : undefined, tabIndex: tabIndex, color_: color, href: to, onClick: (ev) => {
            if (props.disabled) {
                ev.preventDefault();
                return;
            }
