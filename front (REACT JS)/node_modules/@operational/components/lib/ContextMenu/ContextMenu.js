...
const Container = styled_1.default("div")(({ isOpen, theme, align }) => ({
    label: "contextmenu",
    cursor: "pointer",
    position: "relative",
    width: "fit-content",
...
const MenuContainer = styled_1.default("div")(({ theme, align, embedChildrenInMenu }) => ({
    position: "absolute",
 ...
 */
const InvisibleOverlay = styled_1.default("div")(({ theme }) => ({
    position: "fixed",
    top: 0,
    bottom: 0,
    right: 0,
...
class ContextMenu extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(React.Fragment, null,
            isOpen && React.createElement(InvisibleOverlay, { onClick: this.toggle }),
            React.createElement(Container, Object.assign({ isOpen: isOpen }, props, { align: align, onClick: this.toggle, onKeyUp: this.handleKeyPress }),
                renderedChildren,
                isOpen && (React.createElement(MenuContainer, { align: this.props.align, ref: node => (this.menu = node), embedChildrenInMenu: this.props.embedChildrenInMenu },
