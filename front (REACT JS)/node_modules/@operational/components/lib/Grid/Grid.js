...
const Container = styled_1.default("div")(({ theme, gridType }) => (Object.assign({ label: "Grid", width: "100%", height: "100%", display: "grid", alignItems: "flex-start", padding: theme.space.content, gridColumnGap: theme.space.element, gridRowGap: theme.space.element }, getGridCSSProperties(gridType))));
const Grid = (_a) => {
