...
const SidenavHeaderBase = styled_1.default("div")(({ theme, compact }) => ({
    label: "sidenavheader",
    textDecoration: "none",
    width: "100%",
...
const Content = styled_1.default("div")(({ theme, onClick, isCondensed, compact, isActive }) => ({
    textDecoration: "none",
...
const CloseButton = styled_1.default("div")(({ theme, onClick }) => ({
    position: "absolute",
...
const SidenavHeader = (_a) => {
    ...
    return (React.createElement(OperationalContext_1.default, null, ctx => {
        return (React.createElement(SidenavHeaderBase, Object.assign({}, props, { as: href ? "a" : undefined, compact: compact, href: href, onClick: (ev) => {
                if (props.onClick) {
                    props.onClick();
                }
                if (onToggle) {
            ...
            React.createElement(Content, { isActive: isActive, compact: compact, onClick: props.onClick, isCondensed: Boolean(props.condensed) },
                ...
                !props.condensed && (React.createElement(Summary, { compact: compact, isActive: isActive }, truncate_1.truncate(24)(childSidenavItems.map(child => child.props.label).join(", "))))),
