        ...
        , { 
            ...
            React.createElement(Header, { onClick: () => this.toggle() },
                ...
                React.createElement(Icons, null,
                    React.createElement(react_copy_to_clipboard_1.default, { text: JSON.stringify({ currentUrl: isClient_1.isClient() ? window.location.href : "", debug: values }, null, 2), onCopy: this.showCopyFeedback },
