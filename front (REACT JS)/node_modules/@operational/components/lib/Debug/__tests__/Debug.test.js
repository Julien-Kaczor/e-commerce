...
describe("Debug Viewer", () => {
    it("Should handle no data well", () => {
        expect(makeRowsFromConfig_1.makeRowsFromConfig({})).toMatchInlineSnapshot(`Array []`);
    });
    it("Should create table rows from config values", () => {
        ...
        expect(makeRowsFromConfig_1.makeRowsFromConfig(myConfig)).toMatchInlineSnapshot(`
Array [
  <tr>
    <td>
      Name
