...
const Container = styled_1.default("div")(({ size, color, theme, left, right }) => ({
 ...
 */
const AnimationContainer = styled_1.default("div")(({ bounce, size }) => ({
    margin: 0,
    lineHeight: 0,
    width: size || defaultSize,
    height: size || defaultSize,
 ...
 */
const BouncingSpinnerBox = styled_1.default("div")(({ no, theme, color }) => ({
    width: `${(80 / 360) * 100}%`,
    height: `${(80 / 360) * 100}%`,
    position: "absolute",
    top: `${(140 / 360) * 100}%`,
