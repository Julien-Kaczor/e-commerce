...
const NavigationButton = styled_1.default(Button_1.default)(({ type }) => ({
...
const PaginatorControl = ({ children, itemCount, itemsPerPage, page, onChange, type, isDisabled }) => {
    ...
    return (React.createElement(NavigationButton, { type: type, disabled: isDisabled, condensed: true, onClick: clickHandler }, children));
};
