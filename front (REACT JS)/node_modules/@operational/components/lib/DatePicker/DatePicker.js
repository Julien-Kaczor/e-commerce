...
class DatePicker extends React.Component {
    ...
    render() {
        ...
        const datePickerWithoutLabel = (isStandalone) => (React.createElement(DatePicker_styles_1.Container, Object.assign({}, props, { className: isStandalone ? className : undefined, ref: (node) => {
            ...
            React.createElement(DatePicker_styles_1.Input, { isExpanded: this.state.isExpanded, id: domId, readOnly: true, ref: (node) => {
                    this.inputNode = node;
